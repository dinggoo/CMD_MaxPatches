...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.0, 196.0, 180.0, 39.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 910.0, 105.5, 180.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.5, 10.0, 185.0, 39.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 952.0, 58.0, 150.0, 24.0 ],
					"text" : "turn on / off"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 14.0, 961.0, 230.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 893.0, 246.0, 138.0, 39.0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "source.zigsim.maxpat",
				"bootpath" : "~/Documents/GitHub/CMD_MaxPatches/OSC/ZigSim/Iphone",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
